 ...
 * @coversNothing
 */
final class TeacherMobileLessonRepositoryTest extends AcademicTestCase
{
    public function testTodayFiltersCurrentTeacherAndDate(): void
    {
        ...
        $this->lesson($tenantId, $campusId, $classId, $courseId, 102, '2026-06-12 10:00:00');
        $this->lesson($tenantId, $campusId, $classId, $courseId, 101, '2026-06-13 09:00:00');

        $rows = make(TeacherMobileLessonRepository::class)->listToday($tenantId, [$campusId], 101, '2026-06-12');

        self::assertCount(1, $rows);
        self::assertSame((int) $visible->id, (int) $rows[0]['id']);
    }

    public function testPageExcludesOtherTeacherLessons(): void
    {
        [$tenantId, $campusId, $classId, $courseId] = $this->fixture();
        $visible = $this->lesson($tenantId, $campusId, $classId, $courseId, 101, '2026-06-12 09:00:00');
        $this->lesson($tenantId, $campusId, $classId, $courseId, 102, '2026-06-12 10:00:00');
