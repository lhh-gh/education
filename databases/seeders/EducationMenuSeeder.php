...
class EducationMenuSeeder extends Seeder
{
    ...
    private const MENU_TITLES = [
        ...
        'education:admissions:trial-feedback:create' => '试听反馈',
            ...
            $this->menu('education', '教育管理', '/education', '', 'material-symbols:school-outline-rounded', [
                ...
                'children' => [
                    ...
                    $this->group('education:admissions', '招生获客', '/education/admissions', '/education/admissions/leads', 'material-symbols:person-search-outline-rounded', [
                        ...
                        $this->page('education:admissions:trial:page', 'Trial Calendar', '/education/admissions/trials', 'education/views/admissions/TrialLessonCalendar', ['education:admissions:trial:save']),
                        $this->page('education:admissions:trial-feedback:create', 'Trial Feedback', '/education/admissions/trial-feedbacks', 'education/views/admissions/TrialFeedbackList'),
                        $this->page('education:admissions:lead:convert', 'Conversion', '/education/admissions/conversion', 'education/views/admissions/LeadConversionWorkbench'),
