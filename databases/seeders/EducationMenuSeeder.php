...
class EducationMenuSeeder extends Seeder
{
    ...
    private const MENU_TITLES = [
        ...
        'education:workflow:rule:page' => '自动化规则',
        'education:workflow:task:page' => '待办任务',
        'education:workflow:alert:page' => '运营告警',
        'education:workflow:sla:page' => 'SLA 策略',
        'education:workflow:escalation:page' => '升级策略',
        'education:workflow:template:page' => '流程模板',
        'education:workflow:metric:page' => '工作流看板',
        ...
        'education:content:relation:page' => '资料关联',
        'education:content:student-work:page' => '学生作品',
        'education:content:showcase:page' => '成果展陈',
        'education:content:review:page' => '内容审核',
        'education:content:metric:page' => '使用看板',
    ];
            ...
            $this->menu('education', '教育管理', '/education', '', 'material-symbols:school-outline-rounded', [
                ...
                'children' => [
                    ...
                    $this->group('education:finance', '财务中心', '/education/finance', '/education/finance/dashboard', 'material-symbols:payments-outline-rounded', [
                        $this->page('education:finance:dashboard:overview', '财务看板', '/education/finance/dashboard', 'education/views/finance/FinanceDashboard'),
                        $this->page('education:finance:order:page', '订单管理', '/education/finance/orders', 'education/views/finance/FinanceOrderList', ['education:finance:order:create', 'education:finance:payment:offline']),
                        $this->page('education:finance:payment:page', '收款记录', '/education/finance/payments', 'education/views/finance/PaymentRecordList'),
                        $this->page('education:finance:payment-channel:page', '支付渠道', '/education/finance/channels', 'education/views/finance/PaymentChannelList', ['education:finance:payment-channel:save']),
                        $this->page('education:finance:refund:page', '退费管理', '/education/finance/refunds', 'education/views/finance/RefundRequestList', ['education:finance:refund:create', 'education:finance:refund:approve']),
                    ...
                    $this->group('education:group', '集团管控', '/education/group', '/education/group/dashboard', 'material-symbols:account-tree-outline-rounded', [
                        $this->page('education:group:metric:page', '集团看板', '/education/group/dashboard', 'education/views/group/GroupOperationDashboard'),
                        $this->page('education:group:org:tree', '组织架构', '/education/group/org-units', 'education/views/group/OrgUnitTree', ['education:group:org:save']),
                        $this->page('education:group:data-permission:page', '数据权限', '/education/group/data-permissions', 'education/views/group/DataPermissionList', ['education:group:data-permission:save']),
                        $this->page('education:group:approval-template:page', '审批模板', '/education/group/approval-templates', 'education/views/group/ApprovalTemplateList', ['education:group:approval-template:save']),
                        $this->page('education:group:approval-task:page', '审批任务', '/education/group/approval-tasks', 'education/views/group/ApprovalTaskList', ['education:group:approval-task:handle']),
                        $this->page('education:group:contract:page', '合同管理', '/education/group/contracts', 'education/views/group/ContractList', ['education:group:contract:save']),
                        $this->page('education:group:contract-renewal:page', '合同续签', '/education/group/contract-renewals', 'education/views/group/ContractRenewalList'),
                        $this->page('education:group:franchise:page', '加盟管理', '/education/group/franchises', 'education/views/group/FranchiseRecordList', ['education:group:franchise:save']),
                        $this->page('education:group:risk-audit:page', '风控审计', '/education/group/risk-audits', 'education/views/group/RiskAuditEventList'),
                    ]),
                    $this->group('education:family', '家校服务', '/education/family', '/education/family/homework', 'material-symbols:family-restroom-rounded', [
                        $this->page('education:family:comment-template:page', '评语模板', '/education/family/comment-templates', 'education/views/family/CommentTemplateList', ['education:family:comment-template:save']),
                        $this->page('education:family:performance-tag:page', '表现标签', '/education/family/performance-tags', 'education/views/family/PerformanceTagList', ['education:family:performance-tag:save']),
                        $this->page('education:family:homework:page', '课后作业', '/education/family/homework', 'education/views/family/HomeworkAssignmentList', ['education:family:homework:save', 'education:family:homework:review']),
                        $this->page('education:family:report:page', '学习报告', '/education/family/reports', 'education/views/family/LearningReportList', ['education:family:report:publish']),
                        $this->page('education:family:growth:page', '成长记录', '/education/family/growth-records', 'education/views/family/GrowthRecordList', ['education:family:growth:save']),
                        $this->page('education:family:message:page', '家校消息', '/education/family/messages', 'education/views/family/FamilyMessageMonitor', ['education:family:message:reply']),
                        $this->page('education:family:quality:page', '服务质量', '/education/family/quality', 'education/views/family/ServiceQualityDashboard'),
                    ]),
                    ...
                    $this->group('education:growth', '增长转化', '/education/growth', '/education/growth/workbench', 'material-symbols:trending-up-rounded', [
                        $this->page('education:growth:workbench:view', '增长工作台', '/education/growth/workbench', 'education/views/growth/GrowthWorkbench', ['education:growth:campaign:save']),
                        $this->page('education:growth:score:recalculate', '线索评分', '/education/growth/lead-scores', 'education/views/growth/LeadScoreList'),
                        $this->page('education:growth:ai-script:generate', 'AI 话术', '/education/growth/ai-talk-scripts', 'education/views/growth/AiTalkScriptWorkbench', ['education:growth:ai-script:confirm']),
                        $this->page('education:growth:strategy:save', '跟进策略', '/education/growth/followup-strategies', 'education/views/growth/FollowupStrategyList'),
                        $this->page('education:growth:trial-conversion:view', '试听转化', '/education/growth/trial-conversions', 'education/views/growth/TrialConversionList'),
                        $this->page('education:growth:channel-roi:page', '渠道 ROI', '/education/growth/channel-roi', 'education/views/growth/ChannelRoiDashboard', ['education:growth:channel-cost:save']),
                        $this->page('education:growth:consultant-metric:page', '顾问指标', '/education/growth/consultant-metrics', 'education/views/growth/ConsultantMetricDashboard'),
                        $this->page('education:growth:loss:create', '流失原因', '/education/growth/loss-reasons', 'education/views/growth/LossReasonReport', ['education:growth:loss-reason:save']),
                    ]),
                    $this->group('education:standards', '标准化管理', '/education/standards', '/education/standards/packages', 'material-symbols:rule-folder-outline-rounded', [
                        $this->page('education:standards:package:page', '服务包', '/education/standards/packages', 'education/views/standards/ServicePackageList', ['education:standards:package:save', 'education:standards:package:publish']),
                        $this->page('education:standards:stage-goal:page', '阶段目标', '/education/standards/stage-goals', 'education/views/standards/StageGoalEditor', ['education:standards:stage-goal:save']),
                        $this->page('education:standards:ability:page', '能力点', '/education/standards/ability-points', 'education/views/standards/AbilityPointList', ['education:standards:ability:save']),
                        $this->page('education:standards:trial:page', '试听标准', '/education/standards/trial', 'education/views/standards/TrialStandardEditor', ['education:standards:trial:save']),
                        $this->page('education:standards:delivery:page', '交付标准', '/education/standards/delivery', 'education/views/standards/DeliveryStandardEditor', ['education:standards:delivery:save']),
                        $this->page('education:standards:template:page', '服务模板', '/education/standards/templates', 'education/views/standards/ServiceTemplateList', ['education:standards:template:save']),
                        $this->page('education:standards:material:page', '课程资料', '/education/standards/materials', 'education/views/standards/CourseMaterialList', ['education:standards:material:save']),
                        $this->page('education:standards:quality:page', '课程反馈', '/education/standards/feedback', 'education/views/standards/CourseFeedbackList', ['education:standards:feedback:save']),
                        $this->page('education:standards:quality-dashboard:page', '质量看板', '/education/standards/quality', 'education/views/standards/CourseQualityDashboard'),
                        $this->page('education:standards:version:page', '标准版本', '/education/standards/versions', 'education/views/standards/StandardVersionList', ['education:standards:version:publish', 'education:standards:version:localization']),
                        $this->page('education:standards:review:page', '标准评审', '/education/standards/reviews', 'education/views/standards/StandardReviewList', ['education:standards:review:handle']),
                    ]),
                    $this->group('education:content', '内容教研', '/education/content', '/education/content/materials', 'material-symbols:folder-open-outline-rounded', [
                        $this->page('education:content:material:page', '学习资料', '/education/content/materials', 'education/views/content/LearningMaterialList', ['education:content:material:save', 'education:content:material:publish', 'education:content:material:withdraw']),
                        $this->page('education:content:version:page', '资料版本', '/education/content/material-versions', 'education/views/content/MaterialVersionList', ['education:content:version:create']),
                        $this->page('education:content:attachment:page', '资料附件', '/education/content/attachments', 'education/views/content/MaterialAttachmentList', ['education:content:attachment:upload']),
                        $this->page('education:content:relation:page', '资料关联', '/education/content/relations', 'education/views/content/MaterialRelationEditor', ['education:content:relation:save']),
                        $this->page('education:content:student-work:page', '学生作品', '/education/content/student-works', 'education/views/content/StudentWorkList', ['education:content:student-work:publish', 'education:content:student-work:withdraw']),
                        $this->page('education:content:showcase:page', '成果展陈', '/education/content/showcases', 'education/views/content/ShowcaseList', ['education:content:showcase:save', 'education:content:showcase:publish', 'education:content:showcase:withdraw']),
                        $this->page('education:content:review:page', '内容审核', '/education/content/reviews', 'education/views/content/ContentReviewList', ['education:content:review:handle']),
                        $this->page('education:content:metric:page', '使用看板', '/education/content/metrics', 'education/views/content/MaterialUsageDashboard'),
                    ]),
                ],
            ]),
        ];
