...
<template>
  <el-table :data="suggestions" row-key="id">
    ...
    <el-table-column prop="suggestion_text" :label="growthText.fields.suggestion" min-width="220" />
    <el-table-column prop="due_at" :label="growthText.fields.dueAt" width="180" />
