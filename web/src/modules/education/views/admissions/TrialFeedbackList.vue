...
async function submitFeedback() {
  try {
    ...
    successText.value = 'Feedback saved'
  }
  catch (error: any) {
    errorText.value = error?.message ?? 'Feedback save failed'
  }
}
</script>
...
<template>
  <div class="mine-layout admission-page pt-3">
    <el-card shadow="never">
      <template #header><div class="page-header"><span>Trial Feedback</span><el-button type="primary" @click="submitFeedback">Save Feedback</el-button></div></template>
      ...
      <el-form :model="form" label-width="120px">
        <el-form-item label="Trial Lesson"><el-input-number v-model="form.trial_lesson_id" :controls="false" /></el-form-item>
        <el-form-item label="Score"><el-input-number v-model="form.score" :min="0" :max="5" /></el-form-item>
