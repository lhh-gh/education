...
const total = ref(0)
const errorText = ref('')
const search = reactive<ConsumptionReviewPageParams>({ page: 1, pageSize: 20, teacher_id: undefined, lesson_id: undefined, status: undefined, start_at: undefined, end_at: undefined })
