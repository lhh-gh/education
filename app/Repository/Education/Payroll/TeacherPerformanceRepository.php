...
final class TeacherPerformanceRepository
{
    ...
    public function page(array $filters, EducationUserContext $context): array
    {
        ...
        $list = $query->orderByDesc('metric_month')->orderByDesc('id')->forPage($page, $pageSize)->get()->map(static fn (EducationTeacherPerformanceMetric $row): array => $row->toArray())->all();
     ...
     */
    public function create(array $data): EducationTeacherPerformanceMetric
    {
        return EducationTeacherPerformanceMetric::query()->create($data);
    }
}
