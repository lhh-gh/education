...
class EducationWorkflowTaskLog extends Model
{
    protected ?string $table = 'edu_workflow_task_logs';
    ...
    protected array $casts = [
        ...
        'workflow_task_id' => 'integer', 'operator_id' => 'integer',
        'before_status' => WorkflowTaskStatus::class, 'after_status' => WorkflowTaskStatus::class,
