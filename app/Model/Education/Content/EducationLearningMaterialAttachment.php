...
class EducationLearningMaterialAttachment extends Model
{
    protected ?string $table = 'edu_learning_material_attachments';
    ...
    protected array $casts = [
        ...
        'material_version_id' => 'integer', 'file_size' => 'integer',
