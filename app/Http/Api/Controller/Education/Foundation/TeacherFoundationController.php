...
final class TeacherFoundationController extends AbstractController
{
    ...
    #[Get(
        path: '/mobile/education/foundation/teacher/context',
        operationId: 'educationMobileTeacherContext',
        summary: 'Teacher mobile context',
    ...
    {
        return $this->success(
            $this->service->teacherContext($this->service->mobile(), $request->validated())
        );
    }
}
