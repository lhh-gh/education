...
final class GuardianFoundationController extends AbstractController
{
    ...
    #[Get(
        path: '/mobile/education/foundation/guardian/context',
        operationId: 'educationMobileGuardianContext',
        summary: 'Guardian mobile context',
    ...
    {
        return $this->success(
            $this->service->guardianContext($this->service->mobile(), $request->validated())
        );
    }
}
